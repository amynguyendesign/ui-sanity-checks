...
description: Contrast, typography, spacing, and interaction rules every web UI should meet. Grounded in WCAG 2.2 and industry best practices.
---

# UI Sanity Checks

Your fonts, colors, layout, and personality are yours. These checks just make sure real people can actually use what you build, and that it doesn't look like nobody checked.
